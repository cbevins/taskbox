<script>
  ...
  import LiveFuelMoisture from './sliders/DeadFuelMoisture.svelte'
  export let _input
  export let _output
  let f = 50
  let minutes = 60
...
<table>
  <tr>
    ...
    <td><AirTemperature bind:f={$_input.airTemperature.value.i} /></td>
    <td><ElapsedTime bind:minutes={$_input.timeSinceIgnition.value.i} /></td>
  </tr>
</table>
